...
const ZODIAC_DATA = {
  "Aries": {
    emoji: "♈", descripcion: "Pionero, apasionado y directo. Nació para liderar.",
    compatible: ["Leo", "Sagitario", "Géminis"], evitar: ["Cáncer", "Capricornio"],
    consejo: "No intentes ganarle una discusión — simplemente no vale la pena.",
    fortaleza: "Energía inagotable y valentía", debilidad: "Impulsivo y terco como una pared"
  },
  "Tauro": {
    emoji: "♉", descripcion: "Leal, paciente y amante del placer. Es el amigo que nunca falla.",
    compatible: ["Virgo", "Capricornio", "Cáncer"], evitar: ["Acuario", "Leo"],
    consejo: "Jamás lo apresures. Llegará cuando llegue, y llegará bien.",
    fortaleza: "Constancia y confiabilidad", debilidad: "Terco de campeonato cuando se le mete algo"
  },
  "Géminis": {
    emoji: "♊", descripcion: "Curioso, adaptable y brillante. Dos personalidades en una.",
    compatible: ["Libra", "Acuario", "Aries"], evitar: ["Piscis", "Virgo"],
    consejo: "No esperes que tome una decisión rápido. Tiene dos mentes funcionando.",
    fortaleza: "Comunicación e ingenio", debilidad: "Inconstante y difícil de seguirle el paso"
  },
  "Cáncer": {
    emoji: "♋", descripcion: "Intuitivo, protector y profundamente emocional. El corazón del grupo.",
    compatible: ["Escorpio", "Piscis", "Tauro"], evitar: ["Aries", "Libra"],
    consejo: "Cuida sus sentimientos — tiene memoria de elefante para las heridas.",
    fortaleza: "Lealtad y empatía desbordante", debilidad: "Se ofende con facilidad y guarda rencor"
  },
  "Leo": {
    emoji: "♌", descripcion: "Carismático, generoso y espectacular. Nació bajo los reflectores.",
    compatible: ["Aries", "Sagitario", "Géminis"], evitar: ["Tauro", "Escorpio"],
    consejo: "Dale su lugar y su reconocimiento — no es vanidad, es combustible.",
    fortaleza: "Liderazgo natural y generosidad", debilidad: "Ego que a veces ocupa más espacio que él mismo"
  },
  "Virgo": {
    emoji: "♍", descripcion: "Analítico, servicial y perfeccionista. El que resuelve todo sin quejarse.",
    compatible: ["Tauro", "Capricornio", "Cáncer"], evitar: ["Sagitario", "Géminis"],
    consejo: "No le digas 'está bien así' cuando no lo está. Lo sabe.",
    fortaleza: "Precisión y dedicación", debilidad: "Crítico consigo mismo y con los demás"
  },
  "Libra": {
    emoji: "♎", descripcion: "Justo, encantador y diplomático. Odia el conflicto casi tanto como ama la armonía.",
    compatible: ["Géminis", "Acuario", "Leo"], evitar: ["Cáncer", "Capricornio"],
    consejo: "No lo pongas a elegir. Es su kryptonita.",
    fortaleza: "Equilibrio y don de gentes", debilidad: "Indeciso hasta el infinito"
  },
  "Escorpio": {
    emoji: "♏", descripcion: "Intenso, magnético y misterioso. Lo que ves es solo la superficie.",
    compatible: ["Cáncer", "Piscis", "Capricornio"], evitar: ["Leo", "Acuario"],
    consejo: "Nunca le mientas. Lo sabe antes de que termines la oración.",
    fortaleza: "Determinación y profundidad emocional", debilidad: "Rencoroso y celoso cuando se siente traicionado"
  },
  "Sagitario": {
    emoji: "♐", descripcion: "Aventurero, filosófico y honesto. La libertad es su religión.",
    compatible: ["Aries", "Leo", "Libra"], evitar: ["Virgo", "Piscis"],
    consejo: "No intentes enjaularlo. Se irá sin voltear.",
    fortaleza: "Optimismo y sed de conocimiento", debilidad: "Le cuesta comprometerse y a veces es brutalmente honesto"
  },
  "Capricornio": {
    emoji: "♑", descripcion: "Ambicioso, disciplinado y responsable. El que termina lo que empieza.",
    compatible: ["Tauro", "Virgo", "Escorpio"], evitar: ["Aries", "Libra"],
    consejo: "No lo interrumpas cuando está trabajando. Hay consecuencias.",
    fortaleza: "Perseverancia y sentido práctico", debilidad: "Workaholic y a veces frío emocionalmente"
  },
  "Acuario": {
    emoji: "♒", descripcion: "Visionario, original e independiente. Vive en el futuro.",
    compatible: ["Géminis", "Libra", "Sagitario"], evitar: ["Tauro", "Escorpio"],
    consejo: "No le digas que su idea es rara. Para él eso es un cumplido.",
    fortaleza: "Originalidad y pensamiento innovador", debilidad: "Distante emocionalmente y muy en su mundo"
  },
  "Piscis": {
    emoji: "♓", descripcion: "Soñador, empático y creativo. Vive entre la realidad y otro plano.",
    compatible: ["Cáncer", "Escorpio", "Tauro"], evitar: ["Géminis", "Sagitario"],
    consejo: "No lo bombardees con lógica cuando está en modo emocional. Espera.",
    fortaleza: "Intuición y compasión sin límites", debilidad: "Se pierde en sus propios sueños y evita la confrontación"
  }
};

// ── Cápsula: ahora va por el backend ─────────────────────────────────────────
...

{
  ...
  "recomendacion": "Una recomendación de vida divertida y con humor para ${nombre} basada en su signo ${getZodiacName(fecha)}. Algo que podría intentar hacer, con un toque cómico relacionado a la personalidad de su signo."
}`;
...
// ── Akáshicos: ahora va por el backend ───────────────────────────────────────
    ...
    <div style={{
      ...
      <style>{`
        @media print {
          ...
          .print-card {
            ...
            border: 1px solid #ddd !important; border-left-color: inherit !important;
      ...
      <div className="no-print" style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            ...
            <div style={{ fontSize: 12, color: "#6666aa", marginTop: 2 }}>
              ...
              {' '}· 👤 {usuario} · {personas.length} {personas.length === 1 ? "persona" : "personas"} guardadas
            </div>
          </div>
          <button onClick={() => {
        ...
        {upcoming.length > 0 && view === "lista" && (
          <div style={{ marginTop: 16, background: "#1a1a3e", borderRadius: 12, padding: "10px 14px" }}>
            <div style={{ fontSize: 11, color: "#6C63FF", fontWeight: 700, letterSpacing: 1, marginBottom: 8 }}>PRÓXIMOS 30 DÍAS</div>
      ...
      {view === "form" && (
        <div style={{ padding: "20px" }}>
          ...
          {[
            { label: "Nombre *", key: "nombre", placeholder: "¿Cómo se llama?" },
            { label: "Apodo / Como se le llama", key: "apodo", placeholder: "Ej: Güero, Chuy, Lore..." },
            { label: "Gustos / Intereses", key: "gustos", placeholder: "Café, música, libros..." },
            { label: "Notas", key: "notas", placeholder: "Cualquier cosa que quieras recordar..." },
          ].map(f => (
      ...
      {/* Vista detalle — sin cambios en el JSX, solo las funciones fetchCapsula/fetchAkashic ahora van por backend */}
            ...
            <div style={{ padding: "16px 20px" }}>
              ...
              <div style={{ background: "#1a1a2e", borderRadius: 14, padding: 16, marginBottom: 12 }}>
                ...
                {!capsula && !capsulaLoading && (
                  ...
                  }}>✨ Que pasaba el día que Naciste ✨</button>
                )}
                {capsulaLoading && (
                  <div style={{ textAlign: "center", padding: "20px 0", color: "#6666aa", fontSize: 13 }}>
                    <div style={{ fontSize: 28, marginBottom: 8 }}>🔮</div>Viajando en el tiempo...
                  </div>
                )}
                {capsulaError && (
                  <div style={{ color: "#FF6B6B", fontSize: 13, textAlign: "center" }}>
                    {capsulaError}
                    <button onClick={() => handleDescubrirDia(persona)} style={{ display: "block", margin: "8px auto 0", background: "none", border: "none", color: "#6C63FF", cursor: "pointer", fontSize: 13 }}>Intentar de nuevo</button>
                  </div>
                )}
                {capsula && (
                  <div>
                    ...
                    <button onClick={() => setCapsula(null)} style={{ background: "none", border: "none", color: "#444", fontSize: 11, cursor: "pointer", marginTop: 4 }}>× Cerrar</button>
                  </div>
                )}
              </div>

              {/* Tónali Mexica — sin cambios en el JSX */}
              <div style={{ background: "#1a1a2e", borderRadius: 14, padding: 16, marginBottom: 12 }}>
                <div style={{ fontSize: 11, color: "#FFB347", fontWeight: 700, letterSpacing: 1, marginBottom: 12 }}>🦅 TÓNALI — CALENDARIO MEXICA 🦅</div>
                {!tonaliVisible && (
                  ...
                  }}>🌀 Descubrir mi signo Mexica 🌀</button>
                )}
                {tonaliVisible && tonali && (() => {
                  ...
                  return (
                    <div>
                      ...
                      {[
                        { color: "#FFD93D", label: "📅 TRECENA", title: `Ce (1) ${signoTrecena.nombre} · Día ${numero} del ciclo`, desc: signoTrecena.desc },
                        { color: "#C77DFF", label: "🌙 SEÑOR DE LA NOCHE", title: señorNoche.nombre, desc: señorNoche.desc },
                        { color: "#FF6B6B", label: "🔥 SEÑOR DEL DÍA", title: señorDia, desc: `Rige el número ${numero} en el ciclo diurno.` },
                        { color: "#6BCB77", label: "📆 MES SOLAR · XIUHPOHUALLI", title: `Día ${diaSolar} de ${mesSolar.nombre}`, desc: mesSolar.desc },
                        { color: "#4D96FF", label: "🗓️ AÑO", title: `${numAño} ${signoAño.nombre} — ${signoAño.desc}`, desc: "" },
                      ].map((s, i) => (
                      ...
                      <button onClick={() => setTonaliVisible(false)} style={{ background: "none", border: "none", color: "#444", fontSize: 11, cursor: "pointer", marginTop: 10 }}>× Cerrar</button>
                    </div>
                  );
                })()}
              </div>
              ...
              {zodiacData && (
                <div style={{ background: "#1a1a2e", borderRadius: 14, padding: 16, marginBottom: 12 }}>
                  <div style={{ fontSize: 11, color: "#C77DFF", fontWeight: 700, letterSpacing: 1, marginBottom: 12 }}>{zodiacData.emoji} SIGNO ZODIACAL · {signoNombre.toUpperCase()}</div>
              ...
              {/* Registros Akáshicos */}
              <div style={{ background: "#1a1a2e", borderRadius: 14, padding: 16, marginBottom: 12 }}>
                <div style={{ fontSize: 11, color: "#00C9A7", fontWeight: 700, letterSpacing: 1, marginBottom: 12 }}>🌌 LECTURA DEL ALMA — REGISTROS AKÁSHICOS 🌌</div>
                {!akashic && !akashicLoading && (
                  ...
                  }}>🌌 Abrir mi Registro Akáshico 🌌</button>
                )}
                {akashicLoading && (
                ...
                {akashicError && (
                  <div style={{ color: "#FF6B6B", fontSize: 13, textAlign: "center" }}>
                    {akashicError}
                    <button onClick={() => handleLecturaAlma(persona)} style={{ display: "block", margin: "8px auto 0", background: "none", border: "none", color: "#6C63FF", cursor: "pointer", fontSize: 13 }}>Intentar de nuevo</button>
                  </div>
                )}
                {akashic && (() => {
                  const secciones = [
                  ...
                  return (
                    <div>
                      ...
                      <button onClick={() => setAkashic(null)} style={{ background: "none", border: "none", color: "#444", fontSize: 11, cursor: "pointer", marginTop: 8 }}>× Cerrar</button>
                    </div>
                  );
                })()}
              </div>
              ...
              <div style={{ display: "flex", gap: 10, marginTop: 20 }} className="no-print">
                <button onClick={() => handleEdit(persona)} style={{ flex: 1, background: "#1a1a2e", border: "1px solid #2a2a4e", borderRadius: 12, padding: 12, color: "#6C63FF", fontWeight: 700, cursor: "pointer" }}>✏️ Editar</button>
                <button onClick={() => { if (window.confirm("¿Eliminar a " + persona.nombre + "?")) handleDelete(persona.id); }}
                  style={{ flex: 1, background: "#1a1a2e", border: "1px solid #3a1a1a", borderRadius: 12, padding: 12, color: "#FF6B6B", fontWeight: 700, cursor: "pointer" }}>🗑️ Eliminar</button>
              </div>
      ...
      {showAuthor && (
        <div onClick={() => setShowAuthor(false)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.85)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: "20px" }}>
          <div onClick={e => e.stopPropagation()} style={{ background: "linear-gradient(135deg, #1a1a2e, #0f0f1e)", borderRadius: 20, padding: 28, width: "100%", maxWidth: 340, border: "1px solid #00C9A733", textAlign: "center" }}>
            ...
            <div style={{ fontSize: 12, color: "#6666aa", marginBottom: 20 }}>Creador de La Bóveda de Cronos</div>
            <div style={{ background: "#0f0f1e", borderRadius: 12, padding: 14, marginBottom: 20, border: "1px solid #00C9A722" }}>
              <div style={{ fontSize: 11, color: "#00C9A7", fontStyle: "italic", lineHeight: 1.7 }}>"Despertar no es como lo esperabas..."</div>
            </div>
            ...
            <button onClick={() => setShowAuthor(false)} style={{ background: "none", border: "none", color: "#444", fontSize: 12, cursor: "pointer", marginTop: 4 }}>× Cerrar</button>
          </div>
        </div>
      )}
    </div>
